                    ...
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr class="boardCont">
                            <td colspan="3">
                                <div class="td">
                                    <div class="contents-block">
                                        광고 등록에 특별한 제한 사항이 있나요<br /><br /><br />TALENT에서 판매중인 재능만 광고를 할 수 있습니다.<br /><br />TALENT는 재능을 거래하는 ‘재능마켓’입니다.<br /><br />따라서 자신의 재능을 상품화 하여 광고를 할 수 있습니다.<br /><br />하지만  재능이 아닌 특정 회사 및 사이트, 블로그 등의 홍보를 위한 광고 등록은 불가능합니다.<br />
                                        <div class="go_inquiry">답변이 충분하지 않으셨다면, 1:1문의를 이용해 주세요. <a href="./Inquiry.jsp">1:1문의하기 ></a></div>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr class="boardCont">
                            <td colspan="3">
                                <div class="td">
                                    <div class="contents-block">
                                        어떻게 수익금을 출금할 수 있나요<br /><br /><br />수익금은 마이페이지 수익금관리에서 출금 신청할 수 있습니다.<br /><br />재능을 판매하시면 결제 금액에서 수수료 18.3%을 제한 금액이 판매자의 수익금으로 전달됩니다.<br /><br />수익금을 출금하시려면 TALENT 마이페이지 계정관리에서 실명 인증과 계좌 인증을 반드시 하셔야 합니다.<br /><br />사업자일 경우, 사업자등록증사본과 통장사본을 info@mistus.co.kr 으로 첨부하여 보내주시면<br /><br />사업자명으로 인증 처리를 받으실 수 있습니다.
                                        <div class="go_inquiry">답변이 충분하지 않으셨다면, 1:1문의를 이용해 주세요. <a href="./Inquiry.jsp">1:1문의하기 ></a></div>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr class="boardCont">
                            <td colspan="3">
                                <div class="td">
                                    <div class="contents-block">
                                        작업이 길어질 것 같은데 배송완료를 미리 하고 작업을 진행해도 되나요<br /><br /><br />작업이 완벽하게 완료 되었을 때 배송을 완료하시기 바랍니다.<br /><br />만약 작업이 완성되지 않은 채로, 배송완료를 할 경우 구매자는 주문을 수정취소 요청할 권리가 있습니다.<br /><br />늦은 배송이 되더라도 꼭 작업을 마무리하신 후 배송 완료하시기 바랍니다.<br /><br />다만 구매자의 요구가 변경되어 배송이 늦어진 경우에는 TALENT 고객센터로 문의 주시면,<br /><br />판매자의 재능 신뢰도에 영향을 미치지 않도록 조정하도록 하겠습니다.<br />
                                        <div class="go_inquiry">답변이 충분하지 않으셨다면, 1:1문의를 이용해 주세요. <a href="./Inquiry.jsp">1:1문의하기 ></a></div>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr class="boardCont">
                            <td colspan="3">
                                <div class="td">
                                    <div class="contents-block">
                                        재능 광고란 무엇인가요<br /><br /><br />자신의 재능을 더 많은 구매자에게 노출하는 방법 중 하나로 TALENT 재능 광고를 신청할 수 있습니다.<br /><br />TALENT 재능 광고를 신청하시면 등록 된 재능을 TALENT의 메인 페이지에 노출하여,<br /><br />TALENT 사이트를 방문하는 모든 사용자가 볼 수 있게 됩니다.<br /><br />실제로 TALENT의 메인 페이지에 노출되는 재능은 그렇지 않은 재능보다 월등히 높은 판매율을 보이고 있습니다. <br /><br />더 자세한 내용은 사이트 하단 광고하기를 확인해 주세요.<br />
                                        <div class="go_inquiry">답변이 충분하지 않으셨다면, 1:1문의를 이용해 주세요. <a href="./Inquiry.jsp">1:1문의하기 ></a></div>
                                    </div>
                                </div>
                            </td>
                    ...
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr class="boardCont">
                            <td colspan="2">
                                <div class="td">
                                    <div class="contents-block">
                                        재능을 등록하면 언제부터 판매할 수 있나요<br /><br /><br />신규재능일 경우 업무 시간 이내(월요일 ~ 금요일 0900 ~ 1800)에 관리자 승인 후 TALENT에 노출 됩니다.<br /><br />휴일 및 공휴일에는 승인이 되지 않으니 참고해주시기 바랍니다.<br /><br />이미 승인이 된 재능의 경우 수정을 요청할 경우 수정 전 내용으로 판매가 지속되며,<br /><br />추후 최종 승인이 된 뒤에는 수정 된 내용이 반영 되어 노출 됩니다. <br /><br />단순히 재능을 수정한 경우라도 TALENT 재능 규정에 어긋난다면, 승인거절 처리될 수 있습니다.<br />
                                        <div class="go_inquiry">답변이 충분하지 않으셨다면, 1:1문의를 이용해 주세요. <a href="./Inquiry.jsp">1:1문의하기 ></a></div>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr class="boardCont">
                            <td colspan="2">
                                <div class="td">
                                    <div class="contents-block">
                                        재능을 등록할 때 반드시 휴대폰 인증을 받아야 하나요<br /><br /><br />보다 안전하고 원활한 거래를 위해 재능 등록 시 최초 1회에 한해 휴대폰 인증을 시행하고 있습니다.<br /><br />인증 된 휴대폰 번호는 기본적으로 재능 결제가 이루어진 후 구매자에게 노출 되며,<br /><br />해당 휴대폰 번호를 제외하고 업무상 연락이 가능한 다른 연락처가 있을 경우,<br /><br />언제든지 TALENT 마이페이지 프로필 화면 혹은 재능 등록 시 변경 및 재등록이 가능하므로 이용에 많은 참고 부탁 드립니다.<br />
                                        <div class="go_inquiry">답변이 충분하지 않으셨다면, 1:1문의를 이용해 주세요. <a href="./Inquiry.jsp">1:1문의하기 ></a></div>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr class="boardCont">
                            <td colspan="2">
                                <div class="td">
                                    <div class="contents-block">
                                        판매중인 재능이 갑자기 중단승인거절 되었어요<br /><br /><br />TALENT의 안전거래 정책에 위반 되는 행위로 인해 필터링 되었거나<br /><br />관련 사항에 대한 신고가 있었을 경우 판매 중인 재능이 삭제 될 수 있습니다.<br /><br />일반적인 삭제 사유는 다음과 같습니다.<br />-직거래 유도 적발<br />-주문판매 후 연락두절<br />-홍보스팸메시지 대량 발송<br />-욕설, 협박, 성인 메시지 전송<br />-일방적 주문취소 신고<br />-사기성 판매 (재능설명과 전혀 다를 경우)<br />-주문 후 외부거래 유도 적발<br />-불법, 저작권 침해<br /><br /> <br /><br />심사 대기 중이었던 재능이 승인 되지 못하고 승인이 거절 되는 것은,<br /><br />등록하신 재능이 재능등록 심사규정 상의 항목에 따라 승인 과정에서 거절 된 것이며<br /><br />거절 사유는 TALENT 메세지를 통해 안내 드리고 있사오니 이용에 참고하여 주시기 바랍니다.<br /><br /> <br /><br />만약 위의 사항에 해당하지 않는데도 불구하고 재능 승인이 거절 되었거나 삭제 되었다면 <br /><br />TALENT 고객센터로 문의해주시기 바랍니다.<br />
                                        <div class="go_inquiry">답변이 충분하지 않으셨다면, 1:1문의를 이용해 주세요. <a href="./Inquiry.jsp">1:1문의하기 ></a></div>
                                    </div>
                                </div>
                            </td>
