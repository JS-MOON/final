                    ...
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr class="boardCont">
                            <td colspan="3">
                                <div class="td">
                                    <div class="contents-block">
                                        어떻게 수익금을 출금할 수 있나요<br /><br /><br />수익금은 마이페이지 수익금관리에서 출금 신청할 수 있습니다.<br /><br />재능을 판매하시면 결제 금액에서 수수료 18.3%을 제한 금액이 판매자의 수익금으로 전달됩니다.<br /><br />수익금을 출금하시려면 미스터스 마이페이지 계정관리에서 실명 인증과 계좌 인증을 반드시 하셔야 합니다.<br /><br />사업자일 경우, 사업자등록증사본과 통장사본을 info@talent.co.kr 으로 첨부하여 보내주시면<br /><br />사업자명으로 인증 처리를 받으실 수 있습니다.
                                        <div class="go_inquiry">답변이 충분하지 않으셨다면, 1:1문의를 이용해 주세요. <a href="./Inquiry.jsp">1:1문의하기 ></a></div>
                                    </div>
                                </div>
                            </td>
