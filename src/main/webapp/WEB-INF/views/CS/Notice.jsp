                ...
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr class="boardCont">
                        <td colspan="2">
                            <div class="td">
                                <div class="contents-block">
                                    안녕하세요 TALENT팀 입니다.<br /><br />TALENT가 새롭게 발돋움합니다.<br /><br />재능마켓의 새로운 패러다임으로<br /><br />신선한 재능과 알찬 내용들로<br /><br />만족시켜드리겠습니다.
                                    <div class="go_inquiry">답변이 충분하지 않으셨다면, 1:1문의를 이용해 주세요. <a href="./Inquiry.jsp">1:1문의하기 ></a></div>
                                </div>
                            </div>
                        </td>
